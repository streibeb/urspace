				...
				<div class="signupSection">
					<form action="posted.php" method="POST" enctype="multipart/form-data" id="postForm">
						<fieldset class="largeColorsec">
							<legend>Add new note(s)</legend>

							Upload notes: <input type="file" name="postPic"></input>

							<span class="errorMsg" id="errorUrl"></span><br></br>
							Note(s) description: <br></br><textarea class="textBox" name="post1" rows="3" cols="100"></textarea>
